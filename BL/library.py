...
class Library:
    def __init__(self, repo: MoviesRepo) -> None:
        self._repo = repo
        self._repo.repo.create_movies_table()
    ...
    def add_movie(self, cmc: CreateMovieCommand) -> Movie:
        ...
        self._repo.repo.add_movie(new_movie)
        return new_movie

    def get_latest_movies(self, number_of_movies: int) -> list:
        return self._repo.repo.get_latest_movies(number_of_movies)

    def get_movie(self, movie_id: int) -> Movie:
        latest_movies = self._repo.repo.get_latest_movies(movie_id)
